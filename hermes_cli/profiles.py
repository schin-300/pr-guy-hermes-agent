...
_HERMES_SUBCOMMANDS = frozenset({
    "chat", "model", "gateway", "overlay", "setup", "whatsapp", "login", "logout",
...
_hermes_completion() {
    ...
    if [[ "$COMP_CWORD" == 1 ]]; then
        local commands="chat model gateway overlay setup status cron doctor config skills tools mcp sessions profile update version"
